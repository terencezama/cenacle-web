...
class ShareListScreen extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (
      listShare.response &&
      state.rows != listShare.response.docs &&
      !listShare.fetching
    ) {
      ...
      deleteShare.response &&
      state.delete != deleteShare.response &&
      !deleteShare.fetching
    ) {
...
const mapDispatchToProps = dispatch => ({
  listShareRequest: params =>
    dispatch(performAction(params, request(list(SHARE)))),
  deleteShareRequest: params =>
    dispatch(performAction(params, request(remove(SHARE)))),
  notifyRequest: params => dispatch(performAction(params, request(NOTIFY)))
});
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(ShareListScreen));
