...
class EventListScreen extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (
      listEvent.response &&
      state.rows != listEvent.response.docs &&
      !listEvent.fetching
    ) {
      ...
      state.delete != deleteEvent.response &&
      !deleteEvent.fetching
    ) {
...
const mapDispatchToProps = dispatch => ({
  listEventRequest: params =>
    dispatch(performAction(params, request(list(EVENT)))),
  deleteEventRequest: params =>
    dispatch(performAction(params, request(remove(EVENT)))),
  notifyRequest: params => dispatch(performAction(params, request(NOTIFY)))
});
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(EventListScreen));
